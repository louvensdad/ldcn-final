...
export type GeneratorDecisionEventType =
  ...
  | 'EXECUTION_DISPATCHED' | 'EXECUTION_COMPLETED' | 'EXECUTION_FAILED' | 'REVIEW_COMPLETED' | 'GATE_EVALUATED' | 'FAILURE_CLASSIFIED' | 'REPAIR_ADVISORY_CREATED' | 'REPAIR_ELIGIBILITY_EVALUATED' | 'REPAIR_COMPLETED' | 'LEARNING_OUTCOME_RECORDED' | 'GENERATOR_STATE_CHANGED';
