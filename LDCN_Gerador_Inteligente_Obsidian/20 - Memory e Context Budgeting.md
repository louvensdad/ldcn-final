---
title: "20 - Memory e Context Budgeting"
aliases:
  - "Memory e Context Budgeting"
tags:
  - ldcn
  - gerador-inteligente
  - arquitetura
...
[[00 - Gerador Inteligente - Mapa Raiz|⬅ Mapa Raiz]] · [[19 - Learning Intelligence e ML|← Anterior]] · [[21 - Governance Segurança e Replanning|Próximo →]]
...
Cada agente recebe só o necessário.

### Exemplo Java Job

```text
Requirements relevant subset
Java Architecture
Backend Plan
affected artifacts
Java capability packs
task
evidence
```
