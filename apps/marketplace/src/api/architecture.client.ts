...
/** Wire shape of GET /missions/:id/intelligent-generator/architecture-decisions. */
...
export const architectureClient = {
  get(missionId: string): Promise<ArchitectureCompositionDto> {
    return apiClient.get<ArchitectureCompositionDto>(`/missions/${missionId}/intelligent-generator/architecture-decisions`);
  },
};
